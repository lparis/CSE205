...
public class Palindrome 
{
    ...
    {
    	// Rule 1: If the string is length 1, it is a palindrome
        // The base case is when the length of pString is less than or equal to 1.
        // In this case, pString is a palindrome, so we return true. 
        if (pString.length() <= 1) 
        {
            return true;
        } 
        ...
        {
            // Check Rule 2. 
        	// If the first and last characters are not the same then
            ...
            {
                // Check Rule 3, the recursive rule. 
            	// We got here because the first and
