...
public class DListTest {
    ...
    private void testCase1() {
        System.out.print("Running test case 1 - tests appending of one element to an empty list... ");
    ...
    private void testCase2() {
        System.out.print("Running test case 2 - tests appending of multiple elements... ");
        DList list = new DList();
        list.append(1);
        list.append(2);
        list.append(3);
    ...
    private void testCase3() {
        System.out.print("Running test case 3: adding one element to an empty list (at pIndex = 0)... ");
        DList list = new DList();
        list.add(0, 1);
        passOrFail(3, list, "1 ");
        System.out.println("List: " + list);
    ...
    private void testCase4() {
        System.out.print("Running test case 4: adding multiple elements to the head of a list (at pIndex = 0)... ");
        DList list = new DList();
        list.add(0, 1);
        list.add(0, 2);
        list.add(0, 3);
    ...
    private void testCase5() {
        System.out.print("Running test case 5: adding multiple elements to the tail of a nonempty list (at pIndex = list.getSize())... ");
        DList list = new DList();
        list.add(0, 1);
    ...
    private void testCase6() {
        System.out.print("Running test case 6: adding multiple elements to the middle of a nonempty list...");
        DList list = new DList();
        list.add(0, 1);
        list.add(1, 2);
        list.add(1, 3);
